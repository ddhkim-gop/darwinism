#!/usr/bin/python3
"""
Local Sleeper poller for Darwinism.  [abbi]
...
on the sibling gameofphones repo 2026-08-04; same owner/schedule, so darwinism is
...
LEAGUE_ID = "1373230564454191104"          # 2026 — keep in step with refresh_transactions.py
REPO = "ddhkim-gop/darwinism"
WORKFLOW = "auto_refresh.yml"
GH = "/opt/homebrew/bin/gh"

STATE_DIR = os.path.expanduser("~/Library/Application Support/darwinism")
